...
- **Mapping boundary**: `docs/decisions/category-to-game-mapping-contract.md`에 category-to-game mapping의 planning boundary만 문서화했으며, implementation, automatic matching, trusted Combined usage, Combined semantics는 아직 구현하지 않았다.
